...
RoomGL_Window::RoomGL_Window(int x, int y, int w, int h, const char* l)
...
void RoomGL_Window::InitializeGL()
{

}

int RoomGL_Window::handle(int event)
{
    switch (event)
    {
    case FL_FOCUS:
